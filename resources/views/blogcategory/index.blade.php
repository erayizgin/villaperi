                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <a href="blog-item.html">
                                        <article>
                                            <div class="image">
                                                <img src="{{ asset('public/assets/images/services-1.jpg') }}" alt="" />
                                            </div>
                                            <div class="text">
                                                <div class="time">
                                                    <span>22</span>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <a href="blog-item.html">
                                        <article>
                                            <div class="image">
                                                <img src="{{ asset('public/assets/images/services-2.jpg') }}" alt="" />
                                            </div>
                                            <div class="text">
                                                <div class="time">
                                                    <span>22</span>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <a href="blog-item.html">
                                        <article>
                                            <div class="image">
                                                <img src="{{ asset('public/assets/images/services-3.jpg') }}" alt="" />
                                            </div>
                                            <div class="text">
                                                <div class="time">
                                                    <span>22</span>
